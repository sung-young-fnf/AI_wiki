...
| 관련문서 | [[AI_Coding_Tools Index]], [[wiki_index]] |

## 개요

MCP(Model Context Protocol) 서버 큐레이션·리뷰·DevOps용·주식 데이터용·Filesystem·GitHub·Figma·NotebookLM 등 MCP 서버 모음 (MCP 설계 원리는 AI_Engineering).
